...
/** Registers validation only while the experimental OIDC4AC feature is enabled. */
public class OIDC4ACAuthorizationCheckProviderFactory implements AuthorizationEndpointCheckProviderFactory {

    public static final String PROVIDER_ID = "oidc4ac-auth-checker";

    @Override
    public AuthorizationEndpointCheckProvider create(KeycloakSession session) {
        return new OIDC4ACAuthorizationCheckProvider();
    }
